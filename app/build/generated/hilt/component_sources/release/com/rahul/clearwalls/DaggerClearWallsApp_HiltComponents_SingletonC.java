    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new HomeViewModel(viewModelCImpl.getWallpapersUseCase(), viewModelCImpl.getEditorPicksUseCase(), viewModelCImpl.getCategoriesUseCase(), viewModelCImpl.toggleFavoriteUseCase());
