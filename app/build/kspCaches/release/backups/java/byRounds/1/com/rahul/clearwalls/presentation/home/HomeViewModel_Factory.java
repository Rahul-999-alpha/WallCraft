...
public final class HomeViewModel_Factory implements Factory<HomeViewModel> {
  ...
  public HomeViewModel get() {
    return newInstance(getWallpapersUseCaseProvider.get(), getEditorPicksUseCaseProvider.get(), getCategoriesUseCaseProvider.get(), toggleFavoriteUseCaseProvider.get());
  }
  ...
  public static HomeViewModel_Factory create(
    ...
    return new HomeViewModel_Factory(Providers.asDaggerProvider(getWallpapersUseCaseProvider), Providers.asDaggerProvider(getEditorPicksUseCaseProvider), Providers.asDaggerProvider(getCategoriesUseCaseProvider), Providers.asDaggerProvider(toggleFavoriteUseCaseProvider));
  }
  ...
  public static HomeViewModel_Factory create(
      ...
      Provider<GetCategoriesUseCase> getCategoriesUseCaseProvider,
      Provider<ToggleFavoriteUseCase> toggleFavoriteUseCaseProvider) {
    return new HomeViewModel_Factory(getWallpapersUseCaseProvider, getEditorPicksUseCaseProvider, getCategoriesUseCaseProvider, toggleFavoriteUseCaseProvider);
  }
  ...
  public static HomeViewModel newInstance(GetWallpapersUseCase getWallpapersUseCase,
    ...
    return new HomeViewModel(getWallpapersUseCase, getEditorPicksUseCase, getCategoriesUseCase, toggleFavoriteUseCase);
  }
}
